...
export class SipcBlockService {
  ...
  constructor(
    @Inject('sipc_block_repo_1') private readonly blockRepo1: typeof Sipc_Block_1,
    @Inject('sipc_block_repo_2') private readonly blockRepo2: typeof Sipc_Block_2,
    @Inject('sipc_block_repo_3') private readonly blockRepo3: typeof Sipc_Block_3
  ) { }
  private readonly repoList = [this.blockRepo1, this.blockRepo2, this.blockRepo3]
